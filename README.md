...
| 기능 | 설명 |
|---|---|
| **이모티콘 확대** | 치지직 채팅 이모티콘에 마우스를 올리면 선명한 원본 이미지를 깔끔한 미리보기로 보여줍니다. 팝업에서 확대 기능과 `90 × 90` / `120 × 120` 크기를 선택할 수 있습니다. |
| **수땡 방송 바로가기** | 팝업 하단 링크에서 수땡 치지직 방송을 바로 엽니다. |
...
│   ├── popup.html             # 설정 팝업 UI (확대 토글, 크기 선택, 방송 링크)
...
│   ├── popup.test.js           # 팝업 UI 및 설정 옵션 회귀 테스트
